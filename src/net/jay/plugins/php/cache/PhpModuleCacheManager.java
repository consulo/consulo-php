...
public class PhpModuleCacheManager implements ModuleComponent {
  ...
  public PhpModuleCacheManager(@NotNull final Module module,
  ...
  public static void registerDeclarationsIndexAndInitFilesCache(@NotNull final Module module,
                                                                @NotNull final PhpModuleFilesCache moduleFilesCache) {
    final Project project = module.getProject();
