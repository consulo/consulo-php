...
public class LightElementUtil
{
	...
	public static LightPhpClass findLightClassByPsi(@NotNull final PhpClass phpClass)
	{
		...
		if(index == null || phpClass.getName() == null)
			return null;
	 ...
	 */
	@Nullable
	public static PHPPsiElement findPsiByLightElement(@NotNull final LightPhpElement element, @NotNull final Project project)
	{
	...
	@Nullable
	private static PHPPsiElement findByPath(@NotNull final PHPFile root, @NotNull final List<Integer> path)
	{
