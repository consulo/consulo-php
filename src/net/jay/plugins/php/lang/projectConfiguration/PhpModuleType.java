...
public class PhpModuleType extends ModuleType<PhpModuleBuilder> implements ApplicationComponent
{
	...
	private class ChoosePHPSdkStep extends ModuleWizardStep
	{
		...
		public ChoosePHPSdkStep(PhpModuleBuilder moduleBuilder, WizardContext wizardContext)
		{
			...
			myChoosePhpSdkCombo.addBrowseFolderListener(PHPBundle.message("choose.php.sdk.path"), null, null, new FileChooserDescriptor(false, true, false, false, false, false)
			{
				@Override
		...
		public boolean validate() throws ConfigurationException
		{
			...
			if(!s.equals(""))
			{
				...
				if(file != null)
				{
					...
					if(!isValidPhpSdkHomeDirectory(file))
						throw new ConfigurationException(PHPBundle.message("invalid.php.sdk.directory.specified"));
					return super.validate();
				}
			}

			int result = Messages.showYesNoDialog(PHPBundle.message("continue.to.work.without.sdk.defined"), PHPBundle.message("confirm.sdk.version"), Messages.getWarningIcon());
