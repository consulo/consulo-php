...
public class PHPHighlightingData
{
	...
	public static final TextAttributesKey DOC_COMMENT = TextAttributesKey.createTextAttributesKey(DOC_COMMENT_ID, SyntaxHighlighterColors.DOC_COMMENT.getDefaultAttributes().clone());
	public static final TextAttributesKey HEREDOC_ID = TextAttributesKey.createTextAttributesKey(HEREDOC_ID_ID, SyntaxHighlighterColors.DOC_COMMENT_TAG.getDefaultAttributes().clone());
	...
	public static final TextAttributesKey EXEC_COMMAND = TextAttributesKey.createTextAttributesKey(EXEC_COMMAND_ID, SyntaxHighlighterColors.STRING.getDefaultAttributes().clone());
	public static final TextAttributesKey ESCAPE_SEQUENCE = TextAttributesKey.createTextAttributesKey(ESCAPE_SEQUENCE_ID, SyntaxHighlighterColors.VALID_STRING_ESCAPE.getDefaultAttributes().clone());
	public static final TextAttributesKey OPERATION_SIGN = TextAttributesKey.createTextAttributesKey(OPERATION_SIGN_ID, SyntaxHighlighterColors.OPERATION_SIGN.getDefaultAttributes().clone());
	...
	public static final TextAttributesKey PREDEFINED_SYMBOL = TextAttributesKey.createTextAttributesKey(PREDEFINED_SYMBOL_ID, HighlighterColors.TEXT.getDefaultAttributes().clone());
	public static final TextAttributesKey EXPR_SUBST_MARKS = TextAttributesKey.createTextAttributesKey(EXPR_IN_STRING_ID, SyntaxHighlighterColors.DOC_COMMENT_MARKUP.getDefaultAttributes().clone());
	...
	public static final TextAttributesKey HEREDOC_CONTENT = TextAttributesKey.createTextAttributesKey(HEREDOC_CONTENT_ID, SyntaxHighlighterColors.STRING.getDefaultAttributes().clone());
	...
	public static final TextAttributesKey CONSTANT = TextAttributesKey.createTextAttributesKey(CONSTANT_ID, HighlighterColors.TEXT.getDefaultAttributes().clone());
	public static final TextAttributesKey VAR = TextAttributesKey.createTextAttributesKey(VAR_ID, SyntaxHighlighterColors.KEYWORD.getDefaultAttributes().clone());

	public static final TextAttributesKey COMMA = TextAttributesKey.createTextAttributesKey(COMMA_ID, SyntaxHighlighterColors.COMMA.getDefaultAttributes().clone());
	public static final TextAttributesKey SEMICOLON = TextAttributesKey.createTextAttributesKey(SEMICOLON_ID, SyntaxHighlighterColors.JAVA_SEMICOLON.getDefaultAttributes().clone());

	public static final TextAttributesKey DOC_TAG = TextAttributesKey.createTextAttributesKey(DOC_TAG_ID, SyntaxHighlighterColors.DOC_COMMENT_TAG.getDefaultAttributes().clone());
	public static final TextAttributesKey DOC_MARKUP = TextAttributesKey.createTextAttributesKey(DOC_MARKUP_ID, SyntaxHighlighterColors.DOC_COMMENT_MARKUP.getDefaultAttributes().clone());
