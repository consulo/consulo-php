...
public class PhpGutterUtil {
  ...
  public static void setLineMarkersToEditor(final Project project,
                                            ...
                                            final List<PhpLineMarkerInfo> markers) {
  ...
  private static final Key<PhpLineMarkerInfo[]> PHP_LINE_MARKERS_IN_EDITOR = Key.create("PHP_LINE_MARKERS_IN_EDITOR");
    ...
    @Nullable
    public static PhpLineMarkerInfo[] getLineMarkers(final Document document,
    ...
    public static void setLineMarkers(final Document document,
                                          final PhpLineMarkerInfo[] lineMarkers,
                                          final Project project) {
        ApplicationManager.getApplication().assertIsDispatchThread();
        MarkupModel markup = document.getMarkupModel(project);
