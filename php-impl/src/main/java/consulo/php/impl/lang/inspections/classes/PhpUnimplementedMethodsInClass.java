...
public class PhpUnimplementedMethodsInClass extends PhpInspection {
    ...
    public LocalizeValue getDisplayName() {
        return PhpLocalize.phpInspectionsUnimplemented_methods_in_class();
    }
    ...
    public PsiElementVisitor buildVisitor(@Nonnull final ProblemsHolder holder, boolean isOnTheFly) {
        return new PhpElementVisitor() {
            ...
            public void visitClass(PhpClass clazz) {
                ...
                final List<Function> abstractMethods = new ArrayList<>();
                ...
                if (abstractMethods.size() > 0) {
                    ...
                    holder.registerProblem(clazz.getNameIdentifier(), PhpLocalize.phpInspectionsUnimplemented_methods_in_classDescr(methodList.toString()).get());
                }
            }
        };
    }
